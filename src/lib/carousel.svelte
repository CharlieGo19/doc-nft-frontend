...
<div class="relative flex w-full h-[300px] md:max-w-7xl z-0">
    <button
        class="relative flex w-8 h-8 justify-center items-center select-none mt-auto mb-auto ml-2 sm:visible invisible rounded-md bg-white z-20 border-2 border-black"
        on:click={() => {
    ...
    <button
        class="absolute flex w-8 h-8 justify-center items-center select-none right-0 mt-[134px] mr-2 sm:visible invisible bg-white z-20 rounded-md border-2 border-black"
        on:click={() => {
