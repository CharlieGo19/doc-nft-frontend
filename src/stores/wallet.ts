...
export const isWalletPaired: Writable<boolean> = writable(
    retrieveFromLocal("isWalletPaired", false, true)
);
export const pairedWallet: Writable<string | null> = writable(
    retrieveFromLocal("pairedWallet", null, false)
);
...
export const walletObj: Writable<HashConnect | BladeSigner | undefined> =
    writable(undefined);
...
export const hashPackExtensionData: Writable<HashConnectTypes.WalletMetadata> =
    writable();
