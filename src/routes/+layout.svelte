...
<div
    class="relative h-screen w-full flex flex-col overflow-x-hidden space-y-14 md:overflow-y-auto bg-gradient-to-b from-light-mint to-white z-0">
    <div>
        <Toasts />
        <div
            class="w-full flex flex-col fixed bg-black/60 backdrop-blur-lg z-40 md:hidden">
        ...
        <div
            class="hidden md:flex w-full items-center py-2 bg-black/60 backdrop-blur-lg">
            <div
                ...
                <div id="search" class="grow-2">
                    ...
                    <input
                        class="border-none w-full bg-white h-10 px-2 rounded-lg text-sm focus:outline-none"
                        type="search"
                        ...
                        <div
                            ...
                            {#if showUserResults}
                                ...
                                <div
                                    ...
                                    <span
                                        class="w-full mx-auto px-2 rounded-md text-black font-semibold bg-light-mint"
                                        >Creators and Users</span>
                ...
                <div
                    id="launchPad"
                    class="grow flex h-full justify-center items-center hover:font-bold hover:cursor-pointer rounded-md hover:text-black hover:bg-light-mint/80">
                    Launch Pad
                </div>
                <div
                    id="explore"
                ...
                <div
                    id="account"
                    class="flex h-full justify-center items-center text-left grow hover:cursor-pointer rounded-md hover:text-black hover:bg-light-mint/80"
                    ...
                    {#if showAccountMenu}
                        ...
                        <div
                            class="absolute mt-[254px] w-56 bg-black/60 backdrop-blur-lg rounded-b-md focus:outline-none text-center text-white"
                            ...
                            <div class="p-2" role="none">
                                <a
                                    href="/"
                                    class="block px-4 py-2 rounded-md text-sm hover:bg-light-mint hover:text-black"
                                    role="menuitem"
                                    tabindex="-1"
                                    id="menu-item-0">Dark Mode</a>
                                <a
                                    href="/"
                                    class="block px-4 py-2 rounded-md text-sm hover:bg-light-mint hover:text-black"
                                    role="menuitem"
                                ...
                                <a
                                    href="/"
                                    class="block px-4 py-2 text-sm rounded-md hover:bg-light-mint hover:text-black"
                                    role="menuitem"
                                    tabindex="-1"
                ...
                <div
                    id="wallet"
                    class="flex h-full justify-center items-center text-left grow rounded-md hover:text-black hover:bg-light-mint/80">
                    <button
                        type="button"
                        ...
                        <svg
                            ...
                            <desc
                                ...
                                Hashpack and Blade, multi wallet pairing coming
                                soon...</desc>
                            <path
    ...
    <div class="text-stone-700 md:w-1/4 mx-auto">
        <div class="w-full">
            ...
            <div class="w-5/6 mx-auto pt-4 text-center font-light text-sm">
                {$nftMarketPlace} MARKET IS THE NEWEST NFT MARKETPLACE BUILT FOR
                HEDERA. OUR MISSION IS TO MAKE NFTS SIMPLE. EXPLORE THE MARKET TO
                GET STARTED!
            </div>
