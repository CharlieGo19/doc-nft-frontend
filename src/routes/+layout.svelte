<script lang="ts">
    ...
    import { darkTheme, toggleDarkMode } from "src/stores/theme";
    ...
    $: {
        ...
        showCollectionResults =
            searchResults.collections.length > 0 ? true : false;
...
<div class:dark>
    <div
        class="relative h-screen w-full flex flex-col overflow-x-hidden space-y-14 md:overflow-y-auto bg-gradient-to-b from-light-mint to-white z-40 dark:from-black dark:to-deep-dark-mint">
        <div>
            <Toasts />
            <div
                class="w-full flex flex-col fixed bg-black/60 dark:bg-white backdrop-blur-lg md:hidden">
                    ...
                    <div class="relative w-1/6 ml-auto mr-0">
                        <button
                            ...
                            <div
                                ...
                                <span
                                    class="absolute h-1 w-1/3 right-4 bg-light-mint rounded-md -translate-y-2 {showMobileMenu ===
                                    true
                                        ? 'opacity-0'
                                        : ''} transition duration-300" />
                                <span
                                    class="absolute h-1 w-1/3 right-4 bg-light-mint rounded-md {showMobileMenu ===
                                    true
                                        ? '-rotate-45'
                ...
                <div class="flex flex-row">
                    {#if showMobileMenu}
                        ...
                        <div
                            ...
                            <span
                                class="p-2 hover:rounded-md hover:font-bold hover:bg-light-mint hover:text-black"
                                >LightModeSwitch</span>
                            <span
                                class="p-2 hover:rounded-md hover:font-bold hover:bg-light-mint hover:text-black"
                                >Launch Pad</span>
                            <span
                            ...
                            <span
                                ...
                                >Account</span>
                            <button
                                class="p-2 hover:rounded-md hover:font-bold hover:bg-light-mint hover:text-black text-left {iwp ===
                                true
                                    ? 'font-bold'
                                    : ''}"
                                on:click={() => {
                    ...
                    {#if showMobileSearch}
                        <div
                            class="flex flex-col w-full pt-0 pb-2 px-4 z-40"
                            transition:slide={{
                                duration: 300,
                                easing: linear,
                            }}>
                            ...
                            {#if showUserResults}
                                <div
                                    class="w-full flex flex-col py-2 text-white">
                                    <span class="p-1" />
                                    <span
                                        class="w-full mx-auto px-2 rounded-md text-center text-black font-semibold bg-light-mint"
                                        >Creators and Users</span>
                                    <span class="p-1" />
                                    {#each searchResults.users as user}
                                        <!-- TODO: Convert these to links. -->
                                        <span
                                            class="px-2 hover:rounded-md hover:font-bold hover:bg-light-mint hover:text-black"
                                            >{user.value}</span>
                                    {/each}
                                </div>
                            {/if}
            ...
            <div
                ...
                <div
                    class="flex flex-row w-full h-11 justify-between space-x-2 place-items-center text-center max-w-7xl m-auto font-medium text-sm text-white">
                    <div id={NFT_MARKET_PLACE} class="grow z-0">
                        <a href="/">{NFT_MARKET_PLACE.toUpperCase()}</a>
                    </div>
                    <div id="search" class="grow-2">
                        <!-- TODO: Provide drop down with options of filtered NFTs / Projects-->
                        <input
                            class="border-none w-full bg-white h-10 px-2 rounded-lg text-sm focus:outline-none text-black"
                            type="search"
                        ...
                        {#if showDesktopSearch}
                            <div
                                class="absolute w-4/5 max-w-4xl inset-x-auto z-10 mt-[10px] rounded-md bg-black/60 text-white backdrop-blur-lg"
                                tabindex="-1"
                                on:mouseleave={() =>
                                    toggleMenu("desktopSearch")}>
                                {#if showUserResults}
                                    ...
                                    <div
                                        ...
                                        <span
                                            class="w-full mx-auto px-2 rounded-md text-black dark:text-white font-semibold bg-light-mint dark:bg-dark-mint"
                                            >Creators and Users</span>
                                        <!-- <hr class="w-[98%] h-px mx-auto bg-white border-0" /> -->
                                        <div
                                            class="grid grid-cols-5 md:grid-cols-3 py-2">
                                            {#each searchResults.users as user}
                                                <!-- TODO: Convert these to links. -->
                                                <span
                                                    class="px-2 hover:rounded-md hover:font-bold hover:bg-light-mint dark:hover:bg-dark-mint hover:text-black dark:hover:text-white"
                                                    >{user.value}</span>
                                            {/each}
                                        </div>
                                    </div>
                                ...
                                {#if showCollectionResults}
                                    <div
                                        class="w-full flex flex-col px-2 text-white"
                                        transition:slide={{
                                            duration: 200,
                                            easing: linear,
                                        }}>
                    ...
                    <div
                        id="launchPad"
                        class="grow flex h-full justify-center items-center hover:font-bold hover:cursor-pointer rounded-md hover:text-black  hover:bg-light-mint/80 dark:hover:bg-dark-mint">
                        Launch Pad
                    </div>
                    <div
                        id="explore"
                    ...
                    <div
                        id="account"
                        class="flex h-full justify-center items-center text-left grow hover:cursor-pointer rounded-md hover:text-black dark:hover:text-white hover:bg-light-mint/80 dark:hover:bg-dark-mint"
                        ...
                        <button
                            ...
                            <svg
                                ...
                                <title>Account</title>
                                <desc
                                    >Account: access notifications, profile, NFT
                                    Studio for creators and site settings.</desc>
                                <path
                                    stroke-linecap="round"
                                    stroke-linejoin="round"
                        ...
                        {#if showAccountMenu}
                            <div
                                ...
                                <div class="p-2" role="none">
                                    <span
                                        class="block px-4 py-2 rounded-md text-sm hover:bg-light-mint dark:hover:bg-dark-mint hover:text-black dark:hover:text-white"
                                        role="menuitem"
                                        tabindex="-1"
                                        id="menu-item-0"
                                    ...
                                    <a
                                        href="/"
                                        class="block px-4 py-2 rounded-md text-sm hover:bg-light-mint hover:text-black dark:hover:bg-dark-mint"
                                        role="menuitem"
                                        tabindex="-1"
                                    ...
                                    <a
                                        href="/"
                                        class="block px-4 py-2 text-sm rounded-md hover:bg-light-mint hover:text-black dark:hover:bg-dark-mint"
                                        role="menuitem"
                                        tabindex="-1"
                    ...
                    <div
                        id="wallet"
                        class="flex h-full justify-center items-center text-left grow rounded-md hover:text-black dark:hover:text-white hover:bg-light-mint/80 dark:hover:bg-dark-mint">
                        <button
                            type="button"
                            ...
                            <svg
                                ...
                                <title>Wallet</title>
                                <desc
                                    >Wallet: Pair with your cryto wallets via
                                    Hashpack and Blade, multi wallet pairing
                                    coming soon...</desc>
                                <path
                    ...
                    <!-- If adjust this param, change menu right param -->
                </div>
            </div>
        </div>
        ...
        <div class="md:w-1/4 mx-auto text-stone-700 dark:text-white">
            <div class="w-full">
                <img
                    src={nftMarketPlaceLogo}
                    alt={NFT_MARKET_PLACE}
                    class="h-9 mx-auto" />
                <div
                    class="w-5/6 mx-auto pt-4 text-center font-light dark:font-semibold text-sm">
                    {NFT_MARKET_PLACE.toUpperCase()} MARKET IS THE NEWEST NFT MARKETPLACE
                    BUILT FOR HEDERA. OUR MISSION IS TO MAKE NFTS SIMPLE. EXPLORE
                ...
                {#if showResourcesMenu}
                    <ul
                        ...
                        <li>
                            <a
                                href="/"
                                class="block px-2 py-2 hover:font-bold hover:bg-mint-edge hover:text-white"
                                >About</a>
                        </li>
                        <li>
                            <a
