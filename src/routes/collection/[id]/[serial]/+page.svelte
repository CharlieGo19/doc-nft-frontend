<script type="ts">
    ...
    $: {
        ...
        nft = homepageTopCollectionFeed.find(
            (obj) => obj.collectionId === serial
        ); // TODO: Add a defult NFT for the platform.
    }
</script>
        ...
        <div class="flex flex-col md:w-2/3 md:pl-9">
            <div class="flex flex-col">
                <div
                    ...
                    <span
                        class="text-2xl md:text-2xl lg:text-4xl font-semibold">
                        {nft?.name}
                    </span>
                ...
                <span
                    ...
                    <span class="w-1/2">
                        <button
                            class="block align-middle h-10 w-36 mt-[2px] mx-auto border-2 border-mint-edge dark:border-dark-mint bg-white font-Poppins font-semibold 
                    ...
                    <span class="w-1/2">
                        <button
                            class="block align-middle h-10 w-36 mt-[2px] mx-auto border-2 border-mint-edge dark:border-dark-mint bg-mint-edge dark:bg-deep-dark-mint text-white font-Poppins font-semibold
            ...
            <div
                ...
                <span
                    class="col-span-2 p-2 text-sm md:text-lg text-center font-bold">
                    Sale
                </span>
                <span class="text-sm p-2 md:text-lg text-right font-bold">
                    Date
                </span>
