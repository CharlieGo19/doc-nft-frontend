...
/**
 *
 * @param x {number} number of pixels to be shifted to the left.
 * @param eleId {HTMLUListElement} element to be shifted
 */
...
/**
 *
 * @param x {number} number of pixels to be shifted to the right.
 * @param eleId {HTMLUListElement} element to be shifted
 */
 ...
 */
export function copyToClipBoard(value: string | null, toastMessage: string): void {
	if (value !== null) {
		const t: Toast = {
